...
export const mailsender = (req, res) => {
    ...
    const recipientMailOptions = {
        ...
        html: `
            <h1 style="color: black;">Thank you for contacting Dr Tooth Smiling Clinic.</h1>
            <p style="text-align:center; color:gray; margin:5px;"> 
            ...
            <strong>Dr Tooth Smiling Clinic </strong>
                <br />
            </p>
        `,
    };
    ...
    transport.sendMail(senderMailOptions, (err, info) => {
        ...
        transport.sendMail(recipientMailOptions, (err, info) => {
            ...
            return res.send(
                "<h1 style='text-align:center;color: green; margin-top:10%'><span style='font-size:60px;'>✅</span> <br />Thank you for contacting Dr Tooth Smiling Clinic! <br />We have received your service request and will respond shortly.</h1> <br /> <a href='/'>HomePage</a>"
            );
        });
    });
}
