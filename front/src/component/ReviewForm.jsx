...
const ReviewForm = ({ onReviewSubmitted }) => {
  ...
  return (
    <div className="max-w-lg mx-auto p-10 font-serif bg-[#fff] shadow-xl rounded-xl mt-10" data-aos="fade-up" data-aos-duration="1000">
      <h2 className="text-3xl font-bold mb-8 text-center text-[#3e2015]" data-aos="fade-up" data-aos-duration="1000">Share Your Experience</h2>
      ...
      {submitted ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="block text-sm font-medium text-[#3e2015]" data-aos="fade-up" data-aos-duration="1000">Name</label>
            <input
              type="text"
              className="w-full px-4 py-2 border border-[#3e2015] rounded-lg"
              value={name}
          ...
          <div>
            <label className="block text-sm font-medium text-[#3e2015]" data-aos="fade-up" data-aos-duration="1000">Rating</label>
            <div className="flex space-x-2 mt-3" data-aos="fade-up" data-aos-duration="1000">
              {[...Array(5)].map((_, index) => (
                <svg
                  ...
                  className={`h-8 w-8 cursor-pointer ${rating > index ? "text-yellow-400" : "text-gray-300"}`}
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
          ...
          <div>
            <label className="block text-sm font-medium text-[#3e2015]" data-aos="fade-up" data-aos-duration="1000">Review</label>
            <textarea
              className="w-full px-4 py-2 border border-[#3e2015] rounded-lg"
              rows="3"
              value={comment}
          ...
          <div className="flex justify-center">
            <button
              type="submit"
              className={`bg-[#3e2015] text-[#F7EAD0] font-bold py-3 px-5 rounded-lg transition-transform duration-300 transform ${isSubmitting ? "opacity-50 cursor-not-allowed" : "hover:scale-105"}`}
