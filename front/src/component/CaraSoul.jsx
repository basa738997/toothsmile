...
const CaraSoul = () => {
  const slides = [
    { id: 0, srcimg: cara2, alt: '', title: '', utitle: " ", subtitle: " ", meta: " "},
  ...
  return (
    <div className="w-full h-full relative overflow-hidden bg-[#F7EAD0]">
      <Carousel
        autoPlay
        infiniteLoop
        showArrows={true}
...
// const CaraSoul = () => {
//   const slides = [
//     { id: 2, srcimg: cara, alt: '', title: '', utitle: "", subtitle: '', meta: '' },
//     { id: 0, srcimg: A1, alt: 'Expert Dental Care', title: 'Dr Tooth Smile Clinic', utitle: "Welcome to", subtitle: "Advanced dental care", meta: "Smile designing | Teeth whitening | Implant | RCT | Crown | dental clinic" },
//   ];

//   return (
//     <div className="w-full h-auto relative overflow-hidden bg-[#F7EAD0]">
//       <Carousel
//         autoPlay
//         infiniteLoop
//         showArrows={true}
...
//               src={slide.srcimg}
//               alt={slide.alt}
//               className="w-full h-64 sm:h-96 lg:h-[500px] object-cover" // Responsive height adjustments
//             />
//             <div className="absolute inset-0 flex flex-col items-start justify-center bg-black bg-opacity-30 text-white p-4 sm:p-8 md:p-12">
//               <motion.h1
//                 className="text-xl sm:text-2xl md:text-3xl font-bold font-serif capitalize text-black"
//                 initial={{ y: -50, opacity: 0 }}
//                 animate={{ y: 0, opacity: 1 }}
//                 transition={{ duration: 0.8, delay: 0.3 }}
//               >
...
//               </motion.h1>
//               <motion.h1
//                 className="text-2xl sm:text-3xl md:text-4xl my-2 sm:my-3 font-bold capitalize font-serif text-black"
//                 initial={{ y: -50, opacity: 0 }}
//                 animate={{ y: 0, opacity: 1 }}
//                 transition={{ duration: 0.8, delay: 0.3 }}
//               >
...
//               </motion.h1>
//               <motion.h3
//                 className="text-sm sm:text-base md:text-lg text-center font-bold font-serif capitalize text-black mt-2"
//                 initial={{ y: 50, opacity: 0 }}
//                 animate={{ y: 0, opacity: 1 }}
//                 transition={{ duration: 0.8, delay: 0.5 }}
//               >
...
//               </motion.h3>
//               <motion.h3
//                 className="text-xs sm:text-sm md:text-base text-center font-bold capitalize text-black mt-2"
//                 initial={{ y: 50, opacity: 0 }}
//                 animate={{ y: 0, opacity: 1 }}
//                 transition={{ duration: 0.8, delay: 0.5 }}
//               >
