    ...
    <div className="relative bg-[#F7EAD0] w-screen py-8">
      <div className="relative max-w-7xl mx-auto flex flex-col md:flex-row items-center md:space-x-8">
        ...
        <div className="md:w-1/2 bg-white p-6 rounded-xl shadow-lg space-y-6" data-aos="zoom-in-up" style={{fontFamily:"roboto slab"}}>
          <h1 className="text-4xl font-bold font-serif text-[#3e2015]" data-aos="zoom-in-up" style={{fontFamily:"roboto slab"}}>
            About us
          </h1>
          ...
          <p className="text-gray-600 text-lg" data-aos="zoom-in-down">
Dr. Tooth Smile Clinic  is a highly advanced dental clinic in Bhilai Chattisgarh. Specialized in offering world-class treatment in Dental Implants, Smile Designing , Cosmetic Dentistry, and all types of Conventional, Preventive, and Surgical procedures.
</p>

<p className="text-gray-600 text-lg" data-aos="zoom-in-down">
We are committed to offering you high-quality Dental Treatment Solutions at Affordable Treatment Cost.
Dr. Harshita Patel (Director)Dr. Tooth Smile Clinic  with a team of highly trained professionals provide excellent Dental Treatment and Attention to the Patients.
